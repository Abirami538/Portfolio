...
<head>
  ...
  <title>Abirami Ashok | Experiment-1</title>
...
<body>
  ...
  <!-- Navbar -->
  <header>
    <h1 class="logo">Abirami Ashok</h1>
    <nav>
    ...
    <div class="hero-content">
        <div class="hero-text">
          <div class="hero-image">
            <img src="C:\Users\admin\Pictures\OIP.webp" alt="Profile Picture">
          </div>
        <h2>Hey there, I'm <span>Abirami Ashok</span></h2>
  ...
  <section id="contact" class="section light">
    <h2>Contact Me</h2>
    <p>Email: abiramiashok1313@gmail.com</p>
    <p>Location:Chennai,India</p>
  </section>

  <!-- Footer -->
  <footer>
    <p>© 2026 Abirami Ashok| Web Page Developed using HTML & CSS</p>
  </footer>
